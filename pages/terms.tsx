  ...
  return (
    <Layout>
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (“you”) and UpBids
        ("Company," “we," “us," or “our”), concerning your access to and use of
        the https://www.upbids.net website as well as any other media form,
      ...
      <p>
        ...
        We will alert you about any changes by updating these Terms of Use, and
      ...
      <p>
        <ul>
          ...
          <li>
            ...
            obscene, vulgar, pornographic, or generally offensive text or
            images.
          </li>
          <li>
          ...
          <li>
            ...
            HTML, CSS, JavaScript, or other code.
          </li>
          <li>
          ...
          <li>
            Upload or publish any obscene, pornographic, or generally offensive
            text or images.
          </li>
        </ul>
      </p>
      ...
      <p>
        ...
        Policy: https://www.upbids.net/privacy. By using the Site, you agree to
